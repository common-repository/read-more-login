...
class PasswordRecoveryChangeView extends FrontPageView
{
    /** @var StatusBar */
    ...
    public function __construct($id, $controller)
    {
        ...
        $this->AddButton('ButtonSavePassword', new PushButton(esc_html__('Save changes', 'read-more-login'), PushButton::METHOD_POST));
