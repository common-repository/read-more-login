...
class SettingsStyleOptions extends OptionModel
{
    const OPTION_NAME = 'ari_read-more-login_style_options';
    ...
    const FORM_LOADING_FADE = 'rml_fade_in_out';
    const FORM_LOADING_V_ROLLING = 'rml_roll_down_up';

    /* The form loading constants is also name of JavaScript to be called for animation. */
    const TEXT_LOADING_NO_ANIMATION = 'no_animations';
    const TEXT_LOADING_FADE = 'rml_fade_in_out';
    const TEXT_LOADING_V_ROLLING = 'rml_roll_down_up';
	const TEXT_LOADING_RELOAD_PAGE = 'rml_reload_page';
