...
class WizardOptions extends OptionModel
{
    const OPTION_NAME = 'ari_read-more-login_wizard_options';

    const SHOW_CONFIG_WIZARD = 'show_config_wizard';

    /* Metadata describing database fields and data properties: */
    static $MetaData = array
    (
        self::SHOW_CONFIG_WIZARD => array(
