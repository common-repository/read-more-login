...
class AdminSettingsFormController extends AdminSettingsPreviewFormController
{
    public function __construct()
    {
        parent::__construct('ARU_ReadMoreLogin\SettingsFormOptions', 'ARU_ReadMoreLogin\AdminFormView');
