...
class AdminSettingsEmailController extends AdminSettingsTabController
{
    public function __construct()
    {
        parent::__construct('ARU_ReadMoreLogin\SettingsEmailOptions', 'ARU_ReadMoreLogin\AdminEmailView');
